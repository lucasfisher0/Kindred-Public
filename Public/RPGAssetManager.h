...
UCLASS()
class KSPROTOTYPE_API URPGAssetManager : public UAssetManager
{
	GENERATED_BODY()
	
public:
	URPGAssetManager() { UE_LOG(LogKindred, Log, TEXT("Kindred Asset Manager active!")); }
	virtual void StartInitialLoading() override;

	/* Static Types for Needed Items */
